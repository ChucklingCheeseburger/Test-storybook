"use strict";
(self["webpackChunktest_storybook"] = self["webpackChunktest_storybook"] || []).push([["vendors-node_modules_storybook_components_dist_formatter-2WMMO6ZP_mjs"],{
...
`?"crlf":"cr":"lf"}function be2(e){switch(e){case"cr":return "\r";case"crlf":return `\r
`;default:return `
...
`)),string+=indentedValue+strings[i+1];}),string}var formatter=memoizerific__WEBPACK_IMPORTED_MODULE_0___default()(2)(async(type,source)=>type===!1?source:type==="dedent"||type===!0?dedent(source):(await qc.format(source,{parser:type,plugins:[dh],htmlWhitespaceSensitivity:"ignore"})).trim());
...
//# sourceMappingURL=vendors-node_modules_storybook_components_dist_formatter-2WMMO6ZP_mjs.iframe.bundle.js.map